...
module.exports = { session: process.env.SESSION_ID || 'zokk',
    ...
    NOM_OWNER: process.env.NOM_OWNER || "𓆩꧁𝕊𝔼ℂ𝕂𒆜𝐋𝐈𝐆𝐇𝐓 𝐘𝐀𝐆𝐀𝐌𝐈꧂𓆪",
    NUMERO_OWNER : process.env.NUMERO_OWNER,              
    LECTURE_AUTO_STATUS: process.env.LECTURE_AUTO_STATUS || "oui",
    TELECHARGER_AUTO_STATUS: process.env.TELECHARGER_AUTO_STATUS || 'non',
    MODE: process.env.MODE_PUBLIC,
    PM_PERMIT: process.env.PM_PERMIT || 'non',
    BOT : process.env.NOM_BOT || '𝐊𝐈𝐑𝐀-𝐁𝐎𝐓',
    URL : process.env.LIENS_MENU || 'https://telegra.ph/file/a35c0fc9a6da30bb589ed.jpg',
